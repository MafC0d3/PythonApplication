...
bg = pygame.image.load('starbg.jpg')

asteroid50 = pygame.image.load('Sprites/obstacol1.png')
asteroid100 = pygame.image.load('Sprites/obstacol2.png')
asteroid150 = pygame.image.load('Sprites/obstacol3.png')
...
class Player(object):
     ...
     def __init__(self):
        self.img = pygame.image.load('Sprites/sprite_ship.png')
     ...
     def moveForward(self):
        self.img = pygame.image.load('Sprites/sprite_ship_move.png')
